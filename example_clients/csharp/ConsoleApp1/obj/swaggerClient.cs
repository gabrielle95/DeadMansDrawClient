...
namespace ConsoleApp1
{
    ...
    public partial class swaggerClient 
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionResponseReturnedProps__>> ExecuteActionForMatchAsync(string id, string wait, IUserAction body)
        {
        ...
        /// <returns>List of Response events executed in response for the Action</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionResponseReturnedProps__>> ExecuteActionForMatchAsync(string id, string wait, IUserAction body, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
    ...
    /// <summary>Card Value including all possible values</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.22.0 (Newtonsoft.Json v11.0.0.0)")]
