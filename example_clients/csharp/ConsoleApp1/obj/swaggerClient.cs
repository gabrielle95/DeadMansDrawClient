...
namespace ConsoleApp1
{
    ...
    public partial class swaggerClient 
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<MatchDTO>> GetMatchesAsync(string at, BoolLikeString? active, string tags, BoolLikeString? wait)
        {
            return GetMatchesAsync(at, active, tags, wait, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>matches</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<MatchDTO>> GetMatchesAsync(string at, BoolLikeString? active, string tags, BoolLikeString? wait, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<MatchDTO> GetMatchAsync(string id, BoolLikeString? waitactive, BoolLikeString? showevents, BoolLikeString? showdebug)
        {
            return GetMatchAsync(id, waitactive, showevents, showdebug, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Match details, with al details when requesting a 'practice' Match</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<MatchDTO> GetMatchAsync(string id, BoolLikeString? waitactive, BoolLikeString? showevents, BoolLikeString? showdebug, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 410)
                        {
                            ...
                            throw new ApiException<ErrorResponse>("No action possible on finished matches.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 500)
                        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 410)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ActionErrorResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                            throw new ApiException<ActionErrorResponse>("No action possible on finished matches.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 500)
                        {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task DeleteMatchAsync(string id, Body body)
        {
        ...
        /// <param name="id">game id</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task DeleteMatchAsync(string id, Body body, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/matches/{id}/terminate");
            urlBuilder_.Replace("{id}", System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<WhoAmiIResponse> GetAuthenticatedUserAsync()
        {
        ...
        /// <returns>The id of the authenticated User.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<WhoAmiIResponse> GetAuthenticatedUserAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<WhoAmiIResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class MatchEventDTO
    {
        ...
        [Newtonsoft.Json.JsonProperty("matchEndedComment", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string MatchEndedComment { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.0.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ActionErrorResponse
    {
        ...
        public System.Collections.Generic.ICollection<MatchEventDTO> Events { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.0.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class WhoAmiIResponse
    {
