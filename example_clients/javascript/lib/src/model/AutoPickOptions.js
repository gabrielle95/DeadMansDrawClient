...
/**
* Enum class AutoPickOptions.
* @enum {}
* @readonly
*/
export default class AutoPickOptions {
    ...
    /**
    * Returns a <code>AutoPickOptions</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AutoPickOptions} The enum <code>AutoPickOptions</code> value.
    */
