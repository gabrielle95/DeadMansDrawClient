...
class HelloWorldResponse(object):
    ...
    def __init__(self, message=None, local_vars_configuration=None):  # noqa: E501
        """HelloWorldResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def message(self):
        """Gets the message of this HelloWorldResponse.  # noqa: E501


        :return: The message of this HelloWorldResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HelloWorldResponse):
            return False
