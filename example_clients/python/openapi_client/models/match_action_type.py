...
class MatchActionType(object):
    ...
    allowable_values = [DRAW, RESPONSETOEFFECT, ENDTURN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """MatchActionType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MatchActionType):
            return False
