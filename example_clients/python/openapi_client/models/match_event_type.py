...
class MatchEventType(object):
    ...
    allowable_values = [MATCHSTARTED, TURNSTARTED, DRAW, CARDPLAYEDEFFECT, RESPONSETOEFFECT, CARDPLACEDTOPLAYAREA, CARDREMOVEDFROMBANK, TURNENDED, MATCHENDED]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """MatchEventType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MatchEventType):
            return False
