...
class CardEffectType(object):
    ...
    allowable_values = [ORACLE, HOOK, CANNON, SWORD, MAP]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """CardEffectType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CardEffectType):
            return False
