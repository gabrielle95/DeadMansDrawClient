...
```
   java -jar SpcJavaClient-1.0-SNAPSHOT-jar-with-dependencies.jar -w -l -t <your unique tag> -p 636438380ef778617e0e5b01 -pw testpass -s https://slhpc2023.appspot.com
```
